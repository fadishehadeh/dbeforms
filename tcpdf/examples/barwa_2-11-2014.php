...
<tr><td width="1000" height="210" ><img src="http://talking222.com/clients/BarwaBank/forms/new/images/logonew.jpg" border="0"  /></td></tr>
<tr><td width="1000" height="20" align="right" style="font-family:Tahoma; font-size:14px;color:#bf863f;" >';

$html.=$_POST["currentdate"].'</td></tr>
<tr><td width="1000" height="66" bgcolor="#bf863f" align="center"  style="font-family:TrajanPro; font-size:17px; color:#ffffff;"><br><br>Funds Transfer / Internal Transfer Within Barwa Bank</td></tr>
...
<tr><td width="1000" height="40" style="font-family:Tahoma; font-size:14px;color:#bf863f;">
	...
	<tr><td width="30" height="25"></td><td width="250" height="25"><b>Please Issue</b></td><td width="300" height="25">Internal Transfer Within Barwa Bank</td></tr>
 ...
 <tr><td width="30" height="31"></td><td width="300" height="25"><b>Currency</b></td><td width="400" height="25">'.$_POST["currency"].'</td></tr>
  <tr><td width="30" height="31"></td><td width="300" height="25"><b>Amount</b></td><td width="400" height="25">'.number_format($_POST["figures"], 2, '.', ',').'</td></tr>
    
     <tr><td width="30" height="31"></td><td width="300" height="25"><b>Beneficiary Name</b></td><td width="400" height="25">'.$_POST["bname"].'</td></tr>
	  
	    <tr><td width="30" height="31"></td><td width="300" height="25"><b>Beneficiary Bank Name</b></td><td width="400" height="25">'.$_POST["bbn"].'</td></tr>
		    <tr><td width="30" height="31"></td><td width="300" height="25"><b>Beneficiary Reference</b></td><td width="400" height="25">'.$_POST["tp"].'</td></tr>
		 <tr><td width="30" height="31"></td><td width="300" height="25"><b>Beneficiary Account No / IBAN</b></td><td width="400" height="25">'.$_POST["acctype"].'- '.$_POST["bacc"].'</td></tr>
 ...
 <tr><td width="500"  align="left" style="font-family:Tahoma; font-size:14px;color:#bf863f;"><table cellpadding="0" cellspacing="0" border="0"><tr><td width="30" height="31"></td><td width="200" height="25"><b>FX Rate</b></td><td width="200" height="25">-------------------------------------</td></tr><tr><td width="30" height="31"></td><td width="200" height="25"></td><td width="200" height="25"></td></tr> <tr><td width="30" height="31"></td><td width="200" height="25"></td><td width="200" height="25"></td></tr><tr><td width="30" height="31"></td><td width="200" height="25"></td><td width="200" height="25"></td></tr></table></td></tr></table></td></tr></table> </td></tr><tr><td width="1000"  border="1"><table cellpadding="0" cellspacing="0" border="0"><tr>
...
$pdf->Output('Internal_Transfer_Within_Barwa_Bank.pdf', 'I');
